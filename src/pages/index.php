...
<div class="row">
	<div class="columns">
		<h1 class="inline-block" style="padding-right: 16px;">h1 - An Equal Amount Of Text</h1><code class="show-for-medium">48px/1.4 +8</code>
		<br>
		<br>
		<h2 class="inline-block" style="padding-right: 16px;">h2 - An Equal Amount Of Text</h2><code class="show-for-medium">40px/1.4 +8</code>
		<br>
		<br>
		<h3 class="inline-block" style="padding-right: 16px;">h3 - An Equal Amount Of Text</h3><code class="show-for-medium">31px/1.4 +8</code>
		<br>
		<br>
		<h4 class="inline-block" style="padding-right: 16px;">h4 - An Equal Amount Of Text</h4><code class="show-for-medium">25px/1.4 +8</code>
		<br>
		<br>
		<h5 class="inline-block" style="padding-right: 16px;">h5 - An Equal Amount Of Text</h5><code class="show-for-medium">20px/1.4 +8</code>
		<br>
		<br>
		<h6 class="inline-block" style="padding-right: 16px;">h6 - An Equal Amount Of Text</h6><code class="show-for-medium">16px/1.4 +8</code>
		<br>
		<br>
		<p class="inline-block" style="padding-right: 16px;">p - An Equal Amount Of Text</p><code class="show-for-medium">16px/1.6 +16</code>
	</div>
</div>
